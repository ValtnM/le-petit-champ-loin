...
export default async function page() {
  const activeProductsRes = await fetch(
    "http://localhost:8080/api/product/active",
    {
      method: "POST",
    }
  );
  ...
  const activeMembersRes = await fetch(
    "http://localhost:8080/api/user/active",
    {
      method: "POST",
    }
  );
  ...
  const activeEventsRes = await fetch(
    "http://localhost:8080/api/event/active",
    {
      method: "POST",
    }
  );
  ...
  const activeLocationsRes = await fetch(
    "http://localhost:8080/api/location/active",
    {
      method: "POST",
    }
  );
  ...
  const activeSuggestionsRes = await fetch(
    "http://localhost:8080/api/suggestion/active",
    {
      method: "POST",
    }
  );
  ...
  const activeArticlesRes = await fetch(
    "http://localhost:8080/api/article/active",
    {
      method: "POST",
    }
  );
      ...
      <section>
        ...
        <article>
          <Link href="/admin/suggestions">
            <div className={styles.title}>
              <FontAwesomeIcon icon={faUstensils} className={styles.linkIcon} />
              <h3>Suggestions</h3>
            </div>
            <div className={styles.numberOfElement}>
              <div className={styles.activeElements}>
